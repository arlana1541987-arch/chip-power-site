  ...
  return (
    <header className="sticky top-0 z-30 border-b border-border/60 bg-background/70 backdrop-blur-xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 md:px-6">
        <a href={sitePath("/")} className="flex items-center gap-2">
        ...
        <nav className="hidden gap-6 text-sm md:flex">
          <a href={sitePath("#calc")} className="hover:text-primary">Калькулятор</a>
          <a href={sitePath("#brands")} className="hover:text-primary">Марки</a>
          <a href={sitePath("#about")} className="hover:text-primary">О нас</a>
          <a href={sitePath("#zayavka")} className="hover:text-primary">Заявка</a>
          <a href={sitePath("#contacts")} className="hover:text-primary">Контакты</a>
        </nav>
        ...
        <a href={sitePath("#zayavka")} className="btn-fire md:hidden rounded-lg px-3 py-2 text-xs font-semibold">Заявка</a>
      </div>
    </header>
  );
}
